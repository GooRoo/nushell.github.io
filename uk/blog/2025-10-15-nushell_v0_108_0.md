...
- The Polars plugin's value types are renamed to be prefixed with `polars_` (e.g. polars\_dataframe) ([#16819])
...
<details><summary>Full implementation of <code>fish-completer</code> from the cookbook.</summary>
